...
import {
  increaseCheckInLikes,
  decreaseCheckInLikes,
  deleteSelectedCheckIn,
  deleteSelectedComment,
  decreaseCheckInComments,
} from "../actions";
  ...
  useEffect(() => {
    if (isFocused) {
      ...
      if (viewedCheckIn) {
        ...
        setCheckInLiked(
          (GLOBAL.activeUserLikes[viewedCheckIn.id] &&
            GLOBAL.activeUserLikes[viewedCheckIn.id].isLiked) ||
            false
        );
  ...
  const fetchComments = async () => {
    try {
      ...
      const checkInComments = (
        await API.graphql(graphqlOperation(commentsByDate, queryParams))
      ).data.commentsByDate.items;
        ...
        {!pageLoading && checkIn && author ? (
          <View style={styles.container}>
            <View style={styles.stickyHeader}>
              ...
              {(GLOBAL.activeUserId == checkIn.userID ||
                GLOBAL.activeUserId == GLOBAL.adminId) && (
                <TouchableOpacity
            ...
            >
              <View style={styles.header}>
                <TouchableOpacity
                  onPress={() => getUserProfile(checkIn.userID)}
                >
              ...
              <View style={styles.content}>
                ...
                {postCardImage ? (
                  <TouchableWithoutFeedback
                    onPress={() => displayFullImage(postCardImage)}
                  >
                    <View style={styles.imageContainer}>
                      <Image
                        style={styles.image}
                        resizeMode={"cover"}
                        source={{ uri: postCardImage }}
                      />
                  ...
                  >
                    <View style={styles.reactionHeader}>
                      <TouchableOpacity
                        ...
                        onPress={() => updateReactionCount(checkIn)}
                      >
                      ...
                      <View>
                        <Text style={styles.reactionText}>
                          {GLOBAL.allCheckIns[checkInId]
                            ? GLOBAL.allCheckIns[checkInId].comments
                            : commentCount}
                          <View style={styles.reactionImage}>
                            <FontAwesome5
                              name="comment"
        ...
        {fullScreenCheckInPhoto ? (
          <View style={styles.imageViewerContainer}>
            <TouchableOpacity
              ...
              onPress={() => setFullScreenCheckInPhoto("")}
            >
            ...
            <View style={styles.imageDisplay}>
              <Image
                style={styles.image}
                resizeMode={"contain"}
                source={{ uri: fullScreenCheckInPhoto }}
              />
            </View>
          </View>
        ) : null}
